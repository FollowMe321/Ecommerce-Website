...
<html lang="en">
    ...
    <body>
         ...
         <!--Blog-->
         <section id="Blog" class="container my-5 py-5">
            <div class="container text-center mt-5">
                <h3>Welcome to the New-Age Fashion Blog</h3>
                 <hr class="mx-auto "> 
                <p class="w-50 mx-auto">
                 <h3><span>We provide  every new fashion trend idea for all age group. So  Join
                    Our community to receive weekly fashion trends,tips and  
                     news from our fashion experts -click the link below 
                     to join our community.....
                 </span></h3>
                </p>
                <p class="w-50 mx-auto">
                <h2>Email address:<span style='color:blue'><a href="http://localhost:8000/index.php">newrace@gmail.com</a></span></h2>
                </p>
